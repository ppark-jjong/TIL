...
@EnableWebSecurity //WebSecurity 기능을 활성화 시키겠다
@EnableMethodSecurity(prePostEnabled = true) // @PreAuthorize 어노테이션을 메소드 단위로 추가하기 위한 어노테이션
@Configuration
...
//                exception 포인트를 jwt패키지에 만든 예외 포인트 클래스로 지정
